...
exports.Search = exports.GetCourse = void 0;
var server_1 = require("../server");
var GetCourse = /** @class */ (function () {
    function GetCourse() {
        this.method = server_1.Method.GET;
        this.path = "/api/course/:code";
    }
    GetCourse.prototype.handler = function (_a, _b) {
...
var Search = /** @class */ (function () {
    function Search() {
        this.method = server_1.Method.GET;
        this.path = "/api/course/search/:term";
    }
    Search.prototype.handler = function (_a, _b) {
        var params = _a.params;
        var prisma = _b.prisma;
        return __awaiter(this, void 0, void 0, function () {
            var term, data;
...
exports["default"] = [GetCourse, Search];
